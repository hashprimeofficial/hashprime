            ...
            {showDeclaration && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#0A0A0A]/80 backdrop-blur-sm p-4">
                    <div className="bg-[#121212] border border-[#d4af35]/30 rounded-2xl p-6 max-w-md w-full shadow-2xl">
                        <h3 className="text-xl font-black text-white mb-2">Fund Declaration & Terms</h3>
                        <p className="text-white/70 text-sm mb-6 leading-relaxed">
                            By proceeding, you agree to create this investment plan. Please note that the invested money is <span className="text-[#d4af35] font-bold">non-refundable</span> until the end of the timeline. {selectedScheme.id === 'limited_inr' && <span className="text-amber-400 font-bold block mt-2">Compulsory 6-month holding/lock-in period applies.</span>}
                        </p>
                    ...
                    <div className="bg-[#0A0A0A] rounded-2xl p-6 flex flex-col justify-between border border-[#d4af35]/20 relative overflow-hidden shadow-inner">
                        ...
                        <div>
                            <p className="text-[#d4af35]/80 font-bold uppercase tracking-widest text-xs mb-2">
                                Expected Return ({selectedScheme.id === 'limited_inr' ? '6 Months holding' : selectedScheme.id.replace('m', ' Months').replace('y', ' Years')})
                            </p>
