...
export default function MarketsPage() {
    ...
    return (
        <div ref={containerRef} className="min-h-screen bg-[#121212]/5 text-slate-100 pt-32 pb-24 px-4 sm:px-6 flex flex-col items-center">
            {/* Background branding */}
            <div className="fixed top-0 right-0 w-[600px] h-[600px] bg-[#d4af35]/10 rounded-full blur-3xl pointer-events-none -translate-y-1/2 translate-x-1/2 z-0"></div>
                                ...
                                return (
                                    <div key={coin.code} className="market-row opacity-0 group flex flex-col md:grid md:grid-cols-12 gap-4 md:items-center px-4 md:px-8 py-5 hover:bg-[#121212]/5/50 transition-colors duration-300">
                                        ...
                                        <div className="hidden md:flex col-span-1 items-center">
                                            <span className="text-sm font-bold text-slate-300 w-8 text-center">{index + 1}</span>
                                        </div>
                                        ...
                                        <div className="hidden md:flex col-span-3 items-center justify-end">
                                            <span className="font-black text-white text-lg group-hover:scale-105 transition-transform origin-right">{formatPrice(coin.rate)}</span>
                                        </div>
