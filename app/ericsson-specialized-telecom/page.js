        ...
        <div className="max-w-7xl mx-auto relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-7 text-left">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/[0.03] border border-white/[0.06] mb-6">
              ...
              <span className="text-xs font-medium tracking-wider text-slate-400 uppercase">Hashprime OEM Division</span>
            </div>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight mb-6 text-white leading-tight">
              ...
              <br />& Network Field Operations
            </h1>
            <p className="text-lg text-slate-400 mb-8 max-w-xl">
              A specialized service division delivering OEM-compliant field installation, commissioning, and technical maintenance for advanced platforms, including Ericsson.
            </p>
          ...
          <div className="lg:col-span-5 relative group">
            ...
            <div className="relative bg-[#0E0E0E] border border-white/[0.06] rounded-3xl overflow-hidden aspect-[16/10] shadow-2xl">
              <img src="/hashprime-ericsson.jpg" alt="OEM-Grade Telecom Integration" className="w-full h-full object-cover group-hover:scale-105 transition-all duration-700" />
            </div>
          </div>
        </div>
      </section>
