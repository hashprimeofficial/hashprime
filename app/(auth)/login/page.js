...
export default function LoginPage() {
    ...
    return (
        <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
            <style>{`
                @keyframes blink {
                    0%, 100% { opacity: 1; text-shadow: 0 0 8px rgba(212,175,53,0.6); }
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="space-y-1.5">
                    ...
                    <input ref={emailRef} type="email" name="email" required autoComplete="email" className={inputClass} placeholder="you@example.com"
