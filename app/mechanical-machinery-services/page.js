      ...
      <section className="relative pt-32 pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto border-b border-white/[0.06]">
        <div className="text-center max-w-4xl mx-auto">
          <div className="inline-flex items-center space-x-2 bg-white/5 border border-white/10 px-4 py-2 rounded-full mb-8">
            <Cog className="w-4 h-4 text-[#d4af35] animate-spin-slow" style={{ animationDuration: '4s' }} />
            <span className="text-sm font-medium tracking-wider text-slate-300 uppercase">Mechanical Division</span>
          </div>
          <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight mb-6">
            <span className="bg-gradient-to-r from-[#d4af35] to-[#E5C158] bg-clip-text text-transparent">Heavy Industrial Machinery</span>
            <br />& Multi-Vehicle Fleet Maintenance
          </h1>
          <p className="text-xl text-slate-400 mb-10 max-w-3xl mx-auto">
            Comprehensive repair, overhaul, and preventive maintenance solutions engineered to minimize downtime and maximize operational efficiency.
          </p>
          <div className="flex items-center justify-center space-x-2 text-sm text-slate-500">
            <Activity className="w-4 h-4 text-[#d4af35]" />
            <span>Operations Supervised by <strong>Mr. Naresh D</strong> — Mechanical & Machinery Operations Head</span>
          </div>
        </div>
      </section>
